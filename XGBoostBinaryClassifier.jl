...
# Gradient Boosting: XGBoost Classifier model on DS1
...
begin
plotly()
Plots.plot(curve.parameter_values, curve.measurements, ylabel="log loss", xlabel="# num_round", label="")
end
...
begin
t_xgb = XGBoostClassifier(eta=beta, num_round=bnumround, objective="binary:logistic")
