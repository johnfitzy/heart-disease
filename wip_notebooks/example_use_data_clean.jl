...
begin
	...
	df = DataFrame(
    	a = [1, 2, missing, 4, "5", "?"],
    	b = [missing, "?", "3", "7", missing, 9], 
		c = [1.0, 2.0, "5.0", "?", missing, 9.0]
	)
...
begin
	...
	df_swiss = CSV.read(
		"../data/DS2/processed.switzerland.data", 
		header=column_names,
		DataFrame
	)
...
typeof(df_swiss.rest_bp)

# ╔═╡ b2eb70b1-a511-48a3-bb18-b52ae5b73755
println(df_swiss.rest_bp)

# ╔═╡ 72bbedb7-6328-4161-b495-9a8ca3b428c6
df_swiss.rest_bp = map(x -> clean_value(x, Int), df_swiss.rest_bp)
