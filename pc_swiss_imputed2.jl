...
- 122 rows x 14 = 1708 data points
- missing 270 values
- 15 % missing in total.
"""
...
# ╔═╡ 436ce708-11ed-4acb-b42a-2a88963b89f0
describe(df1.chol)
#this is a problem? values but essentiallly zero. i think this is a error?

# ╔═╡ eb4ae945-ea9d-4f2e-a165-0d02a2ee278b
describe(df1.restecg)
...
md"""
T test indicated these attributes( ca, thal) are statiscally different from the original dataset with missing values.

- Note the change for chol is rejected is because there is no change (no missing values) but all the rows had been given zero as a value, which I believe it is incorrect
"""
