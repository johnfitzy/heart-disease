...
# Processed.Hungarian.data - Imputed with mean chain imputation
"""
...
# due to missing values, there is a bit of replacement required. Rows with missing "?" values are dropped.
...
# ╔═╡ 13e3cc66-240c-48c5-adf8-7379b8c7b619
df1
...
# ╔═╡ efa17c95-99a9-4f54-abbd-0ce53207f31e
for col in names(df_imp1)
    if eltype(df_imp1[!, col]) == Union{Missing, Float64}
        df_imp1[!, col] = disallowmissing(df_imp1[!, col])
    end
end
...
# ╔═╡ 2b04d7e3-ecce-4d7e-bd1b-8f9471ae3206
create_hist_density_plot(df_imp1.chol, 
...
# ╔═╡ 6742c0a8-0540-437a-ae82-b29a9b17a123
# Histogram and Density Plot for major_vessels
create_hist_density_plot(df_imp1.ca, 
...
# ╔═╡ 3bf78882-2466-4d67-89a1-297cd6e04b3f
begin
	create_bar_plot(
    	data=df_imp1.slop, 
...
md"""
## Statistical test on original data and imputated data
...
manifest_format = "2.0"
project_hash = "8fdbfaf536882e7c6553f1d1bab91f6f1d42301f"
