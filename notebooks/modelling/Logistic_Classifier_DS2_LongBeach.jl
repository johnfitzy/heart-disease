...
md"""
# Logistic Regression - DS2 imputed.processed.long_beach.csv
"""

# ╔═╡ ac0eee90-3679-472a-97be-3d489fc5fa7b
df = CSV.read("../../data/DS2_imputed/imputed.processed.long_beach.csv", 
	delim=',', 
	DataFrame) 
...
begin
	using JLSO
	MLJ.save("../../models/Logistic_Classifier_DS2_Long_Beach_Model.jls", best_model_mach)
end
  ╠═╡ =#
...
- True Positives (TP) for class 0: 2 instances of class 0 were correctly predicted as class 0.
- False Positives (FP) for class 0: 2 instances were incorrectly predicted as class 0 but actually belong to class 1.
- True Negatives (TN) for class 1: 53 instances of class 1 were correctly predicted as class 1.
- False Negatives (FN) for class 1: 3 instances were incorrectly predicted as class 1 but actually belong to class 0.
...
- The AUC for this model is 0.876, which indicates reasonable performance in distinguishing between the classes.
