...
- True Positives (TP) for class 1: 135 instances of class 1 were correctly predicted as class 1.
- False Positives (FP) for class 1: 23 instances were incorrectly predicted as class 1 but actually belong to class 2.
- True Negatives (TN) for class 2: 97 instances of class 2 were correctly predicted as class 2.
- False Negatives (FN) for class 2: 15 instances were incorrectly predicted as class 2 but actually belong to class 1.
