...
# Gradient Boosting: XGBoost Classifier model on Imputed DS2- Hungarian

- This book runs as follows:

1. Clean and flatten as per spec.
...
df= CSV.read("../..data/DS2_imputed/imputed.processed.hungarian.csv", DataFrame)
...
# ╔═╡ b75a58df-30ed-402a-b383-063742a2166c
...
# ╔═╡ 7833423a-a7fd-49bb-8673-036d114fdbc9
...
- The AUC is $auc_u, which is fair.
...
# ╔═╡ d4189e6d-595d-4331-ba15-c4354cccec7e
prec_T=round(calculate_precision(cm_T)*100, digits=2)
...
# ╔═╡ f6f4ae04-ed7a-4660-874e-8c02c40965c5
md"""
- The ROC curve significantly improved compare to the untuned model"""
...
- Precision: $prec_T % (Untuned model: $prec_U %)
- AUC: $auc_t (Untuned model: $auc_u)


- The T-test and Mann-Whitney test showed that they are not statistically different from one another nor the tuned model performed better statistically. Despite that, there is improvement in all metrics including precision and accuracy.
