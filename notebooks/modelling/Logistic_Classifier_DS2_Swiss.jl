...
md"""
# Logistic Classifier - DS2 imputed.processed.swiss.csv
"""

# ╔═╡ ac0eee90-3679-472a-97be-3d489fc5fa7b
df = CSV.read("../../data/DS2_imputed/imputed.processed.swiss.csv", 
	delim=',', 
	DataFrame) 
...
begin
	using JLSO
	MLJ.save("../../models/Logistic_Classifier_DS2_Swiss_Model.jls", best_model_mach)
end
  ╠═╡ =#
...
- True Positives (TP) for class 0: 0 instances of class 0 were correctly predicted as class 0.
- False Positives (FP) for class 0: 0 instances were incorrectly predicted as class 0 but actually belong to class 1.
- True Negatives (TN) for class 1: 35 instances of class 1 were correctly predicted as class 1.
- False Negatives (FN) for class 1:  2 instances were incorrectly predicted as class 1 but actually belong to class 0.
...
- The AUC for this model is 0.35, which indicates poor performance in distinguishing between the classes.
...
begin
	...
	restored_mach = machine("../../models/Logistic_Classifier_DS2_Swiss_Model.jls")
end
  ╠═╡ =#
...
manifest_format = "2.0"
project_hash = "6dcea9481a997e9aa200d1a908284a9e824acc0c"
