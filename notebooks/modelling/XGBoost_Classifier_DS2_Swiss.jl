...
# ╔═╡ 37aeb231-dfd9-40df-bc79-12365ee3b9da
begin
using Pkg
Pkg.activate("../../") 
end
...
# Gradient Boosting: XGBoost Classifier model on Imputed DS2 Switzerland
...
df= CSV.read("../../data/DS2_imputed/imputed.processed.swiss.csv", DataFrame)
...
- The AUC is $auc_u, which is not very good (very close to 0.5=random guessing).
...
# ╔═╡ b3e3d6dc-cc4d-4ee3-9c90-63e5cdf16302
# ╠═╡ disabled = true
# ╠═╡ skip_as_script = true
#=╠═╡
begin
	using JLSO
	MLJ.save("../../models/XGBoost_Classifier_DS2_Swiss_Model.jls", t_mach)
end
  ╠═╡ =#
