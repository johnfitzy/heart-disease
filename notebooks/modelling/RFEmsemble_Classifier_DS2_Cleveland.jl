...
# Random Forest Classifier Ensemble Model on DS2 Cleveland

- This book runs as follows:

1. Clean and flatten DS2 as per spec.
2. Initial build of Random Forest Classifier machine
...
forest = EnsembleModel(model=rfc, n=100)
...
md"""
Based on the number of trees vs log loss trees, where the lowest log loss number the better, the optimal number of trees would be around 128. """
...
begin
	using JLSO
	MLJ.save("../../models/RF_Ensemble_DS2_Cleveland_model.jls", t_mach)
end
  ╠═╡ =#
...
manifest_format = "2.0"
project_hash = "e36182a865eb7be46b8a0b5815b75a8baa032e94"
